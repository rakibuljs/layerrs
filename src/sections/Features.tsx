    ...
    <section className="py-24">
      <div className="container">
        ...
        <h2 className="text-6xl font-medium text-center mt-6 max-w-2xl mx-auto">
          Where power meets
          <span className="text-lime-400  block">simplicity</span>
        </h2>
        <div className="wrapper mt-12 grid grid-cols-1 md:grid-cols-4 gap-8  lg:grid-cols-3">
          <FeatureCard
